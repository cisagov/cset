...
namespace UpgradeLibrary.Upgrade
{
    public class ConvertDatabase1001 : ConvertSqlDatabase
    {
        ...
        public override void Execute(SqlConnection conn)
        {
            ...
            {
                log.Fatal("Error in upgrading assessment version 10.0.0 file to 10.0.1", ex);
                throw new DatabaseUpgradeException("Error in upgrading assessment version 10.0.0 file to 10.0.1");
            }
        }
    }
}
