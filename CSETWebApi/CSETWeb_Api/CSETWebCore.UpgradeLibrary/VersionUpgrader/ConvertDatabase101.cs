...
namespace UpgradeLibrary.Upgrade
{
    public class ConvertDatabase101 : ConvertSqlDatabase
    {
        ...
        public override void Execute(SqlConnection conn)
        {
            ...
            {
                log.Fatal("Error in upgrading assessment version 10.0.1 file to 10.1.0", ex);
                throw new DatabaseUpgradeException("Error in upgrading assessment version 10.0.1 file to 10.1.0");
            }
        }
    }
}
