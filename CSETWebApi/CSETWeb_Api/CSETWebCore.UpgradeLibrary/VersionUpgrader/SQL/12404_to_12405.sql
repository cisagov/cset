...
-- Update GetCombinedOveralls to use Answer_Components_Exploded view directly
-- instead of calling usp_getExplodedComponent stored procedure
...
BEGIN
    ...
    BEGIN
        ...
        -- Use Answer_Components_Exploded view directly instead of stored procedure
        SELECT *
