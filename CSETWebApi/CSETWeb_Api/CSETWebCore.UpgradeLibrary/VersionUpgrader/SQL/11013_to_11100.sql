...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Table = 1176
         Output = 720
         Appen', 'SCHEMA', N'dbo', 'VIEW', N'ExcelExport', NULL, NULL
END TRY
BEGIN CATCH
...
GO
BEGIN TRY
	EXEC sp_updateextendedproperty N'MS_DiagramPane2', N'd = 1400
         NewValue = 1170
         SortType = 1356
         SortOrder = 1416
         GroupBy = 1350
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'ExcelExport', NULL, NULL
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'This is used by the analytics side of CSET to indicate which grouping level should be used by the analytics when comparing assessments that use a certain maturity model', 'SCHEMA', N'dbo', 'TABLE', N'MATURITY_MODELS', 'COLUMN', N'Analytics_Rollup_Level'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
