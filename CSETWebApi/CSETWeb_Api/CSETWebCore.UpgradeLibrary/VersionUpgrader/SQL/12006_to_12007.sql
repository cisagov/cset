...
Script created by SQL Compare version 14.7.8.21163 from Red Gate Software Ltd at 11/8/2022 9:46:24 AM
...
BEGIN
	...
	FROM (select m.mat_question_id,m.Question_Title, m.Parent_Question_Id,i.Action_Items, Regulatory_Citation, a.Answer_Text,m.Maturity_Level_Id, mf.Finding_Id
		...
		where (Action_Items <> '' and a.Answer_Text = 'N') or Auto_Generated = 0
	) a
