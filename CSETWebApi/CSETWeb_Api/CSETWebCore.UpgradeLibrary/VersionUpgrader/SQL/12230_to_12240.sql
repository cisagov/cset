...
Run this script on:
        ...
        (localdb)\INLLocalDB2022.TSAWeb12230    -  This database will be modified

to synchronize it with:

        (localdb)\INLLocalDB2022.CIEWeb12240

You are recommended to back up your database before running this script

Script created by SQL Compare version 14.10.9.22680 from Red Gate Software Ltd at 6/26/2024 2:06:49 PM
...
GO
PRINT N'Altering [dbo].[Get_Cie_Merge_Conflicts]'
GO
-- =============================================
-- Author:		Matt Winston
-- Create date: 4/12/24
...
-- =============================================
ALTER PROCEDURE [dbo].[Get_Cie_Merge_Conflicts]
