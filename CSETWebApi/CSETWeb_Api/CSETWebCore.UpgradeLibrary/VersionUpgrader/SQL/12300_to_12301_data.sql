...
(localdb)\INLLocalDB2022.CSETWeb12300    -  This database will be modified

to synchronize it with:

(localdb)\INLLocalDB2022.CSETWeb12301

You are recommended to back up your database before running this script

Script created by SQL Data Compare version 14.10.9.22680 from Red Gate Software Ltd at 11/5/2024 12:47:16 PM
...
UPDATE [dbo].[MATURITY_QUESTIONS] SET [Question_Text]=N'Contracts with critical service providers are appropriately identified and reviewed to ensure provisions requiring timely notification of cyber incidents are aligned with credit union policy and expectations' WHERE [Mat_Question_Id] = 9921
