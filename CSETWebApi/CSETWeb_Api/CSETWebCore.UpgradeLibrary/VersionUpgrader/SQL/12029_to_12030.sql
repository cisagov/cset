...
Script created by SQL Compare version 14.10.9.22680 from Red Gate Software Ltd at 9/5/2023 2:24:51 PM
...
GO
PRINT N'Altering [dbo].[DETAILS_DEMOGRAPHICS_OPTIONS]'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[DETAILS_DEMOGRAPHICS_OPTIONS] ALTER COLUMN [OptionValue] [int] NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
