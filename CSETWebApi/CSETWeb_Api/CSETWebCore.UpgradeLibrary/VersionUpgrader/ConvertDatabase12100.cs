...
namespace UpgradeLibrary.Upgrade
{
    internal class ConvertDatabase12100 : ConvertSqlDatabase
    {
        ...
        public override void Execute(SqlConnection conn)
        {
            try
            {
                RunFile(Path.Combine(this.applicationPath, "VersionUpgrader", "SQL", "12032_to_12100_V2.sql"), conn);
                RunFile(Path.Combine(this.applicationPath, "VersionUpgrader", "SQL", "12032_to_12100_data_V2.sql"), conn);
