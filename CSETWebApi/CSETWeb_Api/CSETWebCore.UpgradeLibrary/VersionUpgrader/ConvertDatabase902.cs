...
namespace UpgradeLibrary.Upgrade
{
    public class ConvertDatabase902 : ConvertSqlDatabase
    {
        ...
        public override void Execute(SqlConnection conn)
        {
            ...
            {
                log.Fatal("Error in upgrading assessment version 9.0.1 file to 9.0.2.", ex);
                throw new DatabaseUpgradeException("Error in upgrading assessment version 9.0.1 to 9.0.2");
            }
        }
    }
}
