...
namespace CSETWeb_Api.Helpers.sals
{
    
    public class LevelManager
    {
        //different types of sal names
        ...
        private void CreateCSET4SALLevelDictionary(List<UNIVERSAL_SAL_LEVEL> listSALS)
        {
            ...
            foreach (UNIVERSAL_SAL_LEVEL level in listSALS)
            {
                ...
                if (level.Full_Name_Sal == Constants.SAL_LOW)
                {
                    //Handle NONE SAL or 1 as NONE.  Doing away with NONE SAL.
                    this.DictionaryCSET4SALS[1] = level;
                    this.DictionaryCSET4SALS[2] = level;
                }
                else if (level.Full_Name_Sal == Constants.SAL_MODERATE)
                {
                    this.DictionaryCSET4SALS[3] = level;
                }
                else if (level.Full_Name_Sal == Constants.SAL_HIGH)
                {
                    this.DictionaryCSET4SALS[4] = level;
                }
                else if (level.Full_Name_Sal == Constants.SAL_VERY_HIGH)
                {
        ...
        //internal Views.SALS.LevelsSimpleViewModel CreateSALLevelViewModel(string levelName)
        //{
        //    //TODO: Put in database in STANDARD_SPECIFIC_LEVEL
        //    List<SALLevelContentData> list = new List<SALLevelContentData>();
        //    list.Add(new SALLevelContentData() { Content = Constants.SAL_LOW, ToolTip = App.Current.Resources["SAL_LOW_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = Constants.SAL_MODERATE, ToolTip = App.Current.Resources["SAL_MODERATE_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = Constants.SAL_HIGH, ToolTip = App.Current.Resources["SAL_HIGH_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = Constants.SAL_VERY_HIGH, ToolTip = App.Current.Resources["SAL_VERY_HIGH_VALUE_TOOLTIP"] as string });
        //    LevelsSimpleViewModel viewModel = new LevelsSimpleViewModel(list, levelName);
        //    return viewModel;
        //}

        //internal Views.SALS.LevelsSimpleViewModel CreateDodMacSALLevelViewModel()
        //{
        //    //TODO: Put in database in STANDARD_SPECIFIC_LEVEL
        //    List<SALLevelContentData> list = new List<SALLevelContentData>();
        //    list.Add(new SALLevelContentData() { Content = "MAC I", ToolTip = App.Current.Resources["SAL_MAC_I_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = "MAC II", ToolTip = App.Current.Resources["SAL_MAC_II_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = "MAC III", ToolTip = App.Current.Resources["SAL_MAC_III_VALUE_TOOLTIP"] as string });
        //    LevelsSimpleViewModel viewModel = new LevelsSimpleViewModel(list, "DOD Mac Level");
        //    return viewModel;
        //}

        //internal Views.SALS.LevelsSimpleViewModel CreateDodConfidentialLevelViewModel()
        //{
        //    //TODO: Put in database in STANDARD_SPECIFIC_LEVEL
        //    List<SALLevelContentData> list = new List<SALLevelContentData>();
        //    list.Add(new SALLevelContentData() { Content = "Public", ToolTip = App.Current.Resources["SAL_PUBLIC_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = "Sensitive", ToolTip = App.Current.Resources["SAL_SENSITIVE_VALUE_TOOLTIP"] as string });
        //    list.Add(new SALLevelContentData() { Content = "Classified", ToolTip = App.Current.Resources["SAL_CLASSIFIED_VALUE_TOOLTIP"] as string });
        //    LevelsSimpleViewModel viewModel = new LevelsSimpleViewModel(list, "DOD Confidential Level");
        //    return viewModel;
        //}
    }
}
