...
namespace CSET_Main.Common
{
    public class CSETGlobalProperties : ICSETGlobalProperties 
    {
       ...
       {
           get { return System.IO.Path.Combine(Application_Path, "Data\\" + Constants.ASSESSMENT_FILE_NAME); }
       }
       public String AssessmentTemplateLogFilePath
       {
           get { return System.IO.Path.Combine(Application_Path, "Data\\" + Constants.ASSESSMENT_FILE_NAME_LOG); }
       }
       ...
       {
           get { return Path.Combine(Application_Path, "Data\\" + Constants.AGGREGATION_FILE_NAME); }
       }

       public String ControlDatabaseFilePath
       {
           get { return Path.Combine(ControlDatabaseTempDirectory, Constants.CONTROL_DB_FILE_NAME); }
       }
       public String ControlDatabaseLogFilePath
       {
           get { return Path.Combine(ControlDatabaseTempDirectory, Constants.CONTROL_DB_LOG_FILE_NAME); }
       }
