...
namespace CSET_Main.SALS
{
    public class NistProcessingLogic
    {
        ...
        private const string MAX_NIST_SAL_NAME = Constants.SAL_HIGH;
        private static SALLevelNIST SAL_NONE = new SALLevelNIST(0, Constants.SAL_NONE);
        private static SALLevelNIST SAL_LOW = new SALLevelNIST(1, Constants.SAL_LOW);
        private static SALLevelNIST SAL_MODERATE = new SALLevelNIST(2, Constants.SAL_MODERATE);
        private static SALLevelNIST SAL_HIGH = new SALLevelNIST(3, Constants.SAL_HIGH);
        private static SALLevelNIST SAL_VERY_HIGH = new SALLevelNIST(4, Constants.SAL_VERY_HIGH);
        ...
        private List<NISTQuestionPoco> GetNISTQuestionPocos(int assessmentId, CSET_Context db)
        {
            ...
            var list = from a in db.NIST_SAL_QUESTION_ANSWERS
                       join b in db.NIST_SAL_QUESTIONS on a.Question_Id equals b.Question_Id
