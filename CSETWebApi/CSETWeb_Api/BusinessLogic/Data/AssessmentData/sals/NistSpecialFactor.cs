...
namespace CSET_Main.SALS
{
    ...
    public class NistSpecialFactor
    {
        ...
        public void loadFromDb(int assessmentId, CSETWebEntities db)
        {
        ...
        /// <param name="id"></param>
        /// <param name="db"></param>
        public void SaveToDb(int id, CSETWebEntities db)
        {
            NistProcessingLogic nistProcessing = new NistProcessingLogic();
        ...
        private CNSS_CIA_JUSTIFICATIONS getOrCreateNew(String ciaType, int id, Dictionary<String, CNSS_CIA_JUSTIFICATIONS> dbValues, CSETWebEntities db)
        {
            CNSS_CIA_JUSTIFICATIONS cnvalu;
