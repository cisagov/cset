...
namespace CSET_Main.Data.AssessmentData
{
    public class StandardRepository
    {
        ...
        private bool cfats;
        public bool CFATS { get { return cfats; }
            set {
                cfats = value;
        ...
        public StandardManager StandardManager
        {
            get { return standardManager; }
            set { standardManager = value; }
        }
        private IStandardSpecficLevelRepository standardLevel;

        private AssessmentModeData assessmentModeData;


        private Dictionary<String, bool> dictionarySelectedCNSSI = new Dictionary<string, bool>();
        private int assessment_id;

        public StandardRepository(int assessment_id, LevelManager levelManager,
            StandardManager standardManager,
            AssessmentModeData assessmentModeData,
            IStandardSpecficLevelRepository standardLevel)
        {
            this.assessment_id = assessment_id;
            this.levelManager = levelManager;
            this.standardManager = standardManager;
            this.standardLevel = standardLevel;
            this.assessmentModeData = assessmentModeData;
        }
        ...
        public void Init()
        {
            ...
            //this.assessmentModeData.Init(assessmentContextHolder, standard);
            StandardMode = assessmentModeData.GetAssessmentMode();
        ...
        {
            this.assessmentModeData.SaveMode(standardMode);
        }

        public void SetSortSet(string set)
        {
            assessmentModeData.SaveSortSet(set);
        }
        public string GetSortSet()
        {
            return assessmentModeData.GetSortSet();
        }

        public void SetStandardMode()
        {
            assessmentModeData.SaveMode(StandardMode);
        }
        ...
        {
            return standardLevel.GetFullToShort_Name(Confidence_Level);
        }

        public String GetShortNameAvailabilityLevel()
        {
            return standardLevel.GetFullToShort_Name(Availability_Level);
        }

        public String GetShortNameIntegrityLevel()
        {
            return standardLevel.GetFullToShort_Name(Integrity_Level);
        }
