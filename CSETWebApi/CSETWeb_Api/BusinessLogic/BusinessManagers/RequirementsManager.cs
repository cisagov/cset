...
namespace CSETWeb_Api.BusinessManagers
{
    ...
    public class RequirementsManager : QuestionRequirementManager
    {
            ...
            List<FullAnswer> answers, List<DomainAssessmentFactor> domains)
        {
            ...
            response.QuestionDomains = new List<Domain>();
            foreach (var d in domains)
            {
                response.QuestionDomains.Add(BuildDomainResponse(d));
            }
            ...
            foreach (var req in requirements)
            {
                ...
                var targetDomain = response.QuestionDomains.FirstOrDefault(x => x.AssessmentFactorName == dbR.Standard_Category);
    ...
    private Domain BuildDomainResponse(DomainAssessmentFactor domain)
    {
        var d = new Domain()
        {
