...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["CMMC Assessment","1. Intro to the CMMC Model","2. CMMC - Quick Tutorial","3. CMMC Updates","4. Interview and Testing Components ","5. CMMC Levels and Focus Areas","6. CMMC Practices","7. CSET Assessment Steps","7.1. Prepare","7.2. Assessment","3.2. Results","7.3. Reports"],
    DREX_NODE_LINKS: ["index.htm","intro_to_the_cmmc_model.htm","cmmc___quick_tutorial.htm","cmmc_updates.htm","interview_and_testing_components_.htm","cmmc_levels_and_focus_areas.htm","cmmc_practices.htm","cset_assessment_steps.htm","prepare.htm","assessment.htm","3_2__results.htm","reports.htm"],
    DREX_NODE_CHILD_START: [1,8,8,8,8,8,8,8,12,12,12,12],
    DREX_NODE_CHILD_END: [8,8,8,8,8,8,8,12,12,12,12,12],
    DREX_MENU_TYPE: 2,
