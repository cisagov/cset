...
namespace CSETWebCore.DatabaseManager.Tests
{
    ...
    public class DbManagerTests
    {
        ...
        {   
            ...
            string appCode = "CSET";
            DbManager manager = new DbManager(new Version("12.0.1.5"),clientCode, appCode);
            //TODO finish this.
        ...
        public void TestUpgrade()
        {
            ...
            upgrader.UpgradeOnly(new Version("12.0.1.5"), "data source=(localdb)\\mssqllocaldb;initial catalog=TestWeb;persist security info=True;Integrated Security=SSPI;MultipleActiveResultSets=True");
