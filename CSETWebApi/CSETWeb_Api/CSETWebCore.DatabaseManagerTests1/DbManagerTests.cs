...
namespace CSETWebCore.DatabaseManager.Tests
{
    ...
    public class DbManagerTests
    {
        ...
        public void CopyDBAcrossServersTest()
        {
            ...
            string appCode = "CSET";
            DbManager manager = new DbManager(new Version("12.4.0.3"), clientCode, appCode);
            //TODO finish this.
...
#pragma warning restore IDE0090 // Use 'new(...)'
            ...
            upgrader.UpgradeOnly(new Version("12.4.0.3"), "data source=(localdb)\\inllocaldb2022;initial catalog=TestWeb;persist security info=True;Integrated Security=SSPI;MultipleActiveResultSets=True");
