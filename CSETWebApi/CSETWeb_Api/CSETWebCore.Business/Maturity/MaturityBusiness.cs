...
namespace CSETWebCore.Business.Maturity
{
    public class MaturityBusiness : IMaturityBusiness
    {
        ...
        private readonly IACETDashboardBusiness _acetDashboardBusiness;

        public MaturityBusiness(CSET_Context context, IAssessmentUtil assessmentUtil, IACETDashboardBusiness acetDashboardBusiness)
        {
            _context = context;
            _assessmentUtil = assessmentUtil;
            _acetDashboardBusiness = acetDashboardBusiness;
        }
        ...
        public MaturityResponse GetMaturityQuestions(int assessmentId, bool isAcetInstallation, bool fill)
        {
            ...
            {
                response.OverallIRP = _acetDashboardBusiness.GetOverallIrpNumber(assessmentId);
        ...
        {
            var targetLevel = _acetDashboardBusiness.GetOverallIrpNumber(assessmentId);
        ...
        {
            ACETDashboard irpCalculation = _acetDashboardBusiness.GetIrpCalculation(assessmentId);
