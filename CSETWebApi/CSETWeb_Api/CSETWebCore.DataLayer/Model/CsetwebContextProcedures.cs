...
namespace CSETWebCore.DataLayer.Model
{
    ...
    public partial class CsetwebContextProcedures : ICsetwebContextProcedures
    {
        ...
        public virtual async Task<List<usp_CF_QuestionsResult>> usp_CF_QuestionsAsync(int? Assessment_Id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<usp_CF_QuestionsResult>("EXEC @returnValue = [dbo].[usp_CF_Questions] @Assessment_Id = @Assessment_Id", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<usp_CF_Score_OverallResult>> usp_CF_Score_OverallAsync(int? Assessment_Id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<usp_CF_Score_OverallResult>("EXEC @returnValue = [dbo].[usp_CF_Score_Overall] @Assessment_Id = @Assessment_Id", sqlParameters, cancellationToken);
