...
public partial class CsetwebContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ANSWER>(entity =>
        {
            ...
            entity.Property(e => e.Is_Component).HasComputedColumnSql("CAST(CASE \"Question_Type\" WHEN 'Component' THEN true ELSE false END AS BOOLEAN)", false);
            entity.Property(e => e.Is_Framework).HasComputedColumnSql("CAST(CASE \"Question_Type\" WHEN 'Framework' THEN true ELSE false END AS BOOLEAN)", false);
            entity.Property(e => e.Is_Maturity).HasComputedColumnSql("CAST(CASE \"Question_Type\" WHEN 'Maturity' THEN true ELSE false END AS BOOLEAN)", false);
            entity.Property(e => e.Is_Requirement).HasComputedColumnSql("CAST(CASE \"Question_Type\" WHEN 'Requirement' THEN true ELSE false END AS BOOLEAN)", false);
        ...
        modelBuilder.Entity<MATURITY_QUESTIONS>(entity =>
        {
            ...
            entity.Property(e => e.Text_Hash).HasComputedColumnSql("digest(\"Question_Text\", 'sha1')::bytea", true);
        ...
        modelBuilder.Entity<NEW_QUESTION>(entity =>
        {
            ...
            entity.Property(e => e.Question_Hash).HasComputedColumnSql("digest(LEFT(\"Simple_Question\", 8000), 'sha1')::bytea", true);
        ...
        modelBuilder.Entity<NEW_REQUIREMENT>(entity =>
        {
            ...
            entity.Property(e => e.Supp_Hash).HasComputedColumnSql("digest(LEFT(\"Supplemental_Info\", 8000), 'sha1')::bytea", true);
            entity.Property(e => e.Text_Hash).HasComputedColumnSql("digest(\"Requirement_Text\", 'sha1')::bytea", true);
        ...
        modelBuilder.Entity<UNIVERSAL_SUB_CATEGORY_HEADINGS>(entity =>
        {
            ...
            entity.Property(e => e.Display_Radio_Buttons).HasComputedColumnSql("CAST(CASE WHEN \"sub_heading_question_description\" IS NULL OR LENGTH(TRIM(\"sub_heading_question_description\")) = 0 OR POSITION('?' IN \"sub_heading_question_description\") = 0 THEN false ELSE true END AS BOOLEAN)", false);
