...
public partial class CsetwebContext : DbContext
{
    ...
    public virtual DbSet<METRIC_ANSWER_DETAILS> METRIC_ANSWER_DETAILS { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<METRIC_ANSWER_DETAILS>(entity =>
        {
            entity.ToView("METRIC_ANSWER_DETAILS");
        });
