USE [CSETWeb]
GO
/****** Object:  View [dbo].[vQUESTION_HEADINGS]    Script Date: 11/14/2018 3:57:21 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT        dbo.UNIVERSAL_SUB_CATEGORY_HEADINGS.Heading_Pair_Id, dbo.QUESTION_GROUP_HEADING.Question_Group_Heading, 
                         dbo.UNIVERSAL_SUB_CATEGORIES.Universal_Sub_Category
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "UNIVERSAL_SUB_CATEGORY_HEADINGS"
            Begin Extent = 
               Top = 71
               Left = 121
               Bottom = 297
            ...
            TopColumn = 0
         End
         Begin Table = "UNIVERSAL_SUB_CATEGORIES"
            Begin Extent = 
               Top = 180
               Left = 576
               Bottom = 275
            ...
            TopColumn = 0
         End
         Begin Table = "QUESTION_GROUP_HEADING"
            Begin Extent = 
               Top = 6
               Left = 621
               Bottom = 135
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vQUESTION_HEADINGS'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vQUESTION_HEADINGS'
GO
