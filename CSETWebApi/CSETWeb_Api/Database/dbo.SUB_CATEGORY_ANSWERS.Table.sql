USE [CSETWeb]
GO
/****** Object:  Table [dbo].[SUB_CATEGORY_ANSWERS]    Script Date: 6/28/2018 8:21:27 AM ******/
SET ANSI_NULLS ON
GO
...
GO
INSERT [dbo].[SUB_CATEGORY_ANSWERS] ([Assessement_Id], [Heading_Id], [Component_Id], [Is_Component], [Is_Override], [Answer_Text]) VALUES (25, 2, 0, 0, 0, N'N')
INSERT [dbo].[SUB_CATEGORY_ANSWERS] ([Assessement_Id], [Heading_Id], [Component_Id], [Is_Component], [Is_Override], [Answer_Text]) VALUES (33, 2, 0, 0, 0, N'N')
...
GO
ALTER TABLE [dbo].[SUB_CATEGORY_ANSWERS]  WITH CHECK ADD  CONSTRAINT [FK_SUB_CATEGORY_ANSWERS_UNIVERSAL_SUB_CATEGORY_HEADINGS] FOREIGN KEY([Heading_Id])
