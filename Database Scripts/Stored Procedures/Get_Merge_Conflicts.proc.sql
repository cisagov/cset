CREATE PROCEDURE [dbo].[Get_Merge_Conflicts]
    ...
    @id7 int = N
ULL, @id8 int = NULL, @id9 int = NULL, @id10 int = NULL
...
EXEC FillEmptyMaturityQues
tionsForAnalysis @id4
...
EXEC FillEmptyMaturityQuestionsForAnalysi
s @id9
...
SELECT 
    ...
    (SELECT Assessment_Name FROM INFORMATION WHERE Id = @id1) as As
sessment_Name1,
    ...
    (SELECT
 Assessment_Name FROM INFORMATION WHERE Id = @id2) as Assessment_Name2,
    ...
    (SELECT Assessment_Name FROM INFORMATI
ON WHERE Id = @id3) as Assessment_Name3,
    ...
    (SELECT Assessment_Name FROM INFORMATION WHERE Id = @id4) as Assessme
nt_Name4,
...
as Assessment_id5, 
    ...
    f.Ques
tion_Or_Requirement_Id as Question_Or_Requirement_Id6, 
    ...
    g.Question_Or_Requirement_Id as Quest
ion_Or_Requirement_Id7, 
...
FROM (SELECT * FROM ANSWER 
WHERE Assessment_Id = @id1) a
...
FULL OUTER JOIN (SELECT * FROM ANSWER WHERE Asses
sment_Id = @id3) c
...
ON (a.Question_Or_Requirement_Id = d.Question_Or_Requirement_I
d) AND (a.Question_Type = d.Question_Type)
...
FULL OUTER JOIN (SELECT * FROM ANSWER
 WHERE Assessment_Id = @id6) f
...
ON (a.Question_Or_Requirement_Id = g.Question_Or_R
equirement_Id) AND (a.Question_Type = g.Question_Type)
...
FULL OUTER JOIN (SELECT *
 FROM ANSWER WHERE Assessment_Id = @id9) i
...
ON (a.Question_Or_Requirement_Id = j.
Question_Or_Requirement_Id) AND (a.Question_Type = j.Question_Type)

WHERE 
    -- Compare Exam 1 (a) to all other exams being merged
    ((a.Answer_Text != 'U' AND b.Answer_Text != 'U') AND (a.Answer_Text != b.Answer_Text)) OR
    ((a.Answer_Text != 'U' 
AND c.Answer_Text != 'U') AND (a.Answer_Text != c.Answer_Text)) OR
    ...
    ((a.Answer_Text != 'U' AND h.Answer_Text != 'U') AND (a.Answer_
Text != h.Answer_Text)) OR
...
exams being merged
    ...
    ((b.Answer_Text != 'U' AND e.Answer_Text != 
'U') AND (b.Answer_Text != e.Answer_Text)) OR
    ...
    ((b.Answer_Text !
= 'U' AND h.Answer_Text != 'U') AND (b.Answer_Text != h.Answer_Text)) OR
    ((b.Answer_Text != 'U' AND i.Answer_Text != 'U') AND (b.Answer_Text != i.Answer_Text)) OR
    ((b.Answer_Text != 'U' AND j.Answer_Text != 'U') AND (b.Answer_Text != j.Answer_Text
)) OR
    ...
    ((c.Answer_Text != 'U' AND f.A
nswer_Text != 'U') AND (c.Answer_Text != f.Answer_Text)) OR
    ...
    ((c
.Answer_Text != 'U' AND i.Answer_Text != 'U') AND (c.Answer_Text != i.Answer_Text)) OR
    ((c.Answer_Text != 'U' AND j.Answer_Text != 'U') AND (c.Answer_Text != j.Answer_Text)) OR

    -- Compare Exam 4 (d)
    ((d.Answer_Text != 'U' AND e.Answer_Text !=
 'U') AND (d.Answer_Text != e.Answer_Text)) OR
    ...
    ((d.Answer_Text 
!= 'U' AND h.Answer_Text != 'U') AND (d.Answer_Text != h.Answer_Text)) OR
    ((d.Answer_Text != 'U' AND i.Answer_Text != 'U') AND (d.Answer_Text != i.Answer_Text)) OR
    ((d.Answer_Text != 'U' AND j.Answer_Text != 'U') AND (d.Answer_Text != j.Answer_Tex
t)) OR
    ...
    ((e.Answer_Text != 'U' AND h.
Answer_Text != 'U') AND (e.Answer_Text != h.Answer_Text)) OR
...
- Compare Exam 6 (f)
    ...
    ((f.Answer_Text != 'U' AND i.Answer_Text !
= 'U') AND (f.Answer_Text != i.Answer_Text)) OR
    ((f.Answer_Text != 'U' AND j.Answer_Text != 'U') AND (f.Answer_Text != j.Answer_Text)) OR

    -- Compare Exam 7 (g)
    ((g.Answer_Text != 'U' AND g.Answer_Text != 'U') AND (g.Answer_Text != g.Answer_Te
xt)) OR
    ...
    ((g.Answer_Text != 'U' AND j.Answer_Text != 'U') AND (g
.Answer_Text != j.Answer_Text)) OR
