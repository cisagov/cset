...
BEGIN
	...
	create table #componentExploded (UniqueKey int, Assessment_Id int, Answer_Id int, Question_Id int, Answer_Text varchar(50), Comment varchar(2048),
		Alternate_JustificaTion ntext, FeedBack varchar(2048), Question_Number int, QuestionText varchar(7338), C
omponentName varchar(200), Symbol_Name varchar(100),
		...
		Layer_Id int, LayerName varchar(2
50),Container_Id int, ZoneName varchar(250), SAL varchar(20), Mark_For_Review bit, Is_Requirement bit,
