...
Copy-Item -Path database\CSETWeb12023.mdf -Destination C:\CSETDatabase\CSETWeb.mdf -Force
Copy-Item -Path database\CSETWeb12023_log.ldf -Destination C:\CSETDatabase\CSETWeb_log.ldf -Force
