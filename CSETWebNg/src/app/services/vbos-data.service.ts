...
export class VbosDataService {
  ...
  public getVBOSDetail(){
    return this.http.get(this.apiUrl + '/vbosdetail')
  }
  
  public getVBOSQuestions() {
    return this.http.get(this.apiUrl + '/vbosquestions')
  }
}