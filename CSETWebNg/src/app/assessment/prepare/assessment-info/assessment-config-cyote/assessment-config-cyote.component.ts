...
@Component({
  selector: 'app-assessment-config-cyote',
  templateUrl: './assessment-config-cyote.component.html',
  styleUrls: ['./assessment-config-cyote.component.scss']
})
export class AssessmentConfigCyoteComponent implements OnInit {


  expandedDesc: boolean[] = [];

  // the list of features that can be selecteddra
  features: any = [
    {
      code: 'rra',
